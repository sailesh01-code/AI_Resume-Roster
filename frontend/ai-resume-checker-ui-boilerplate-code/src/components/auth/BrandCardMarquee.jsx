  ...
  return (
    <PreviewCard width={300}>
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-[10px] font-semibold bg-[var(--accent-soft)] text-[#5a3dd6]">
      ...
      <div className="relative h-1.5 rounded-full bg-gray-100 overflow-hidden">
        <div
          ...
          style={{
            width: "82%",
            background: "linear-gradient(90deg, #7c5cfc 0%, #5a3dd6 100%)",
          }}
        />
      </div>

      <Footer subtitle="AI Resume Roaster" version="V3 of 3" />
    </PreviewCard>
  );
}
...
function TopIssuesCard() {
  ...
  const TONE = {
    high: "bg-[rgba(239,68,68,0.08)] text-[var(--danger)]",
  ...
  return (
    <PreviewCard width={320}>
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-[10px] font-semibold bg-[rgba(239,68,68,0.08)] text-[var(--danger)]">
          5 found
        </div>
      </div>
    ...
    <PreviewCard width={340}>
      ...
      <div className="space-y-2">
        ...
        <div className="rounded-2xl bg-[var(--accent-soft)] p-3">
          <div className="text-[9px] uppercase tracking-wide text-[#5a3dd6] mb-1 font-semibold">
            Rewritten
          </div>
      ...
      <div className="space-y-2.5">
        <div className="flex flex-wrap gap-1.5">
          {present.map((k) => (
            <span
              key={k}
              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-[var(--accent-soft)] text-[#5a3dd6]"
            >
        ...
        <div className="flex flex-wrap gap-1.5">
          {missing.map((k) => (
            <span
              key={k}
              className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-medium bg-[rgba(239,68,68,0.08)] text-[var(--danger)]"
            >
      ...
      <div className="space-y-2.5">
        {strengths.map((s, i) => (
          <div key={i} className="flex items-start gap-3">
            <div className="h-8 w-8 rounded-xl bg-[var(--accent-soft)] flex items-center justify-center text-[#5a3dd6] shrink-0">
              <Sparkles size={13} />
            </div>
            <div className="flex-1 min-w-0">
