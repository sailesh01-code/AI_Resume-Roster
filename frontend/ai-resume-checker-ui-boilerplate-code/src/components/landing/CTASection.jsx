    ...
    >
      <DarkPanel className="px-6 sm:px-12 lg:px-20 py-16 sm:py-24 text-center">
        ...
        >
          <Link
            to="/register"
            className="group relative inline-flex items-center gap-2 h-12 px-6 rounded-full font-semibold text-[14px] text-white shadow-[0_10px_30px_-8px_rgba(124,92,252,0.5)] hover:shadow-[0_14px_36px_-8px_rgba(124,92,252,0.7)] hover:-translate-y-0.5 active:scale-[0.98] transition-all"
            style={{
              background:
