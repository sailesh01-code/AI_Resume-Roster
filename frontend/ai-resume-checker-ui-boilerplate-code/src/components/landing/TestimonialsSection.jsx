      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
        {TESTIMONIALS.map((t, i) => (
          <motion.div
            ...
            className="rounded-[22px] bg-[var(--surface)] border border-[var(--border)] shadow-card hover:shadow-hover hover:-translate-y-1 transition-all duration-300 p-5 sm:p-6 flex flex-col"
          >
            ...
            <div className="flex items-center gap-3 mt-5 pt-4 border-t border-[var(--border)]">
              <div
                className="h-9 w-9 rounded-full text-white flex items-center justify-center font-display text-[12px] font-semibold tabular"
                style={{
                  background: "linear-gradient(135deg, #7c5cfc, #5a3dd6)",
                }}
              >
                {t.initials}
              </div>
