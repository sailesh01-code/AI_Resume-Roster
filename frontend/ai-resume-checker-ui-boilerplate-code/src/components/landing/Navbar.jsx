      ...
      >
        <div className="flex items-center justify-between gap-4 px-3 sm:px-4 py-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              to="/register"
              className="group inline-flex items-center gap-1.5 h-9 pl-4 pr-3.5 rounded-full text-white text-[13px] font-semibold hover:opacity-90 active:scale-[0.98] transition-all"
              style={{
                background: "linear-gradient(135deg, #7c5cfc 0%, #5a3dd6 100%)",
              }}
            >
              Get started
              <ArrowRight
