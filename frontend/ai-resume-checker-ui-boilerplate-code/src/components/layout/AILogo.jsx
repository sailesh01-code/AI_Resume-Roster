  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, #7c5cfc 0%, transparent 65%)",
          filter: "blur(10px)",
        }}
      ...
      <div className="absolute inset-0 rounded-[16px] overflow-hidden">
        <motion.div
          ...
          style={{
            background:
              "conic-gradient(from 0deg, #5a3dd6, #7c5cfc, #a78bfa, #22d3ee, #7c5cfc, #5a3dd6)",
          }}
          animate={{ rotate: 360 }}
      ...
      <div className="relative h-[38px] w-[38px] rounded-[12px] bg-[var(--surface)] flex items-center justify-center overflow-hidden shadow-[inset_0_1px_2px_rgba(0,0,0,0.04)]">
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, #7c5cfc 0%, #5a3dd6 50%, #7c5cfc 100%)",
